...
Mission: Sh33p Battle Drill - Taking a Hill
Version: 0-0-1
Developer(s): Black Sh33p - GRUBES
Description: Brief battle drill for capturing an enemy fixed position on a hilltop.
...
0-0-1 | 29 06 2014 | Initial Version
...
This mission is (c)2014 Black Sh33p. All rights reserved.
...
1. Move the file SBD-Hill.pbo into the following directory (assuming you have the Steam version of ArmA 3):
...
A simple battle drill for repeated practice of assaulting a hilltop position.
